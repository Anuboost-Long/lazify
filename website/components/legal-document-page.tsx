        ...
        <div className="mt-8 grid gap-10 lg:grid-cols-[minmax(0,1fr)_230px]">
          <article className="min-w-0">
            <header>
              ...
              <p className="mt-4 text-sm text-stone-500">Effective {document.effectiveDate}</p>
            </header>

            <aside className="mt-5 flex gap-3 rounded-2xl border border-amber-300/20 bg-amber-300/6 p-5 text-amber-100">
            ...
            <div className="mt-8">
              {sections.map((section) => (
                <section
                  key={section.id}
                  id={section.id}
                  className="scroll-mt-8 border-t border-white/10 py-8"
                >
          ...
          <aside className="hidden lg:block">
            <nav aria-label="On this page" className="sticky top-8">
              <p className="text-sm text-stone-400">On this page</p>
