...
export function PhotoPreview({
  ...
  return createPortal(
    <div
      className={clsx(
        "photo-preview fixed inset-0 z-[100] bg-black/90 p-3 backdrop-blur-md sm:p-8",
    ...
    >
      ...
      <dialog
        open
        className="relative z-10 mx-auto flex h-full w-full max-w-[1600px] flex-col overflow-hidden rounded-[14px] border border-white/15 bg-[#07100e] p-0 text-inherit shadow-2xl"
