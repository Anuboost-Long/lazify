 ...
 */
export function AppHeader({ app, building, onChangeApp }: Readonly<AppHeaderProps>) {
		...
		<header className="relative flex items-start gap-4">
			...
			<div className="min-w-0 flex-1">
				...
				<div className="mt-1 flex flex-wrap items-center gap-2">
					<CardTitle className="truncate">{app ? app.name : t(translation.DmgCompiler.Title)}</CardTitle>
