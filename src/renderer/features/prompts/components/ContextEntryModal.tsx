...
import { contextType, renderContext, type ContextPayload, type ContextTypeId } from "@main/prompts/context-types";
            ...
            <div className="flex flex-wrap gap-1.5 pt-1">
              {presets.map((preset) => {
                ...
                return (
                  ...
                  >
                    <CaptionText className={on ? "!text-accent" : "!text-muted"}>
                      {preset.name}
                    </CaptionText>
                  </button>
                );
