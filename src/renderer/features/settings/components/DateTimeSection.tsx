...
import type { DateFormatId, TimeFormatId } from "./settings-config";
import { DATE_FORMAT_OPTIONS, TIME_FORMAT_OPTIONS } from "./settings-config";
  ...
  return (
    <div className="border-t border-border pt-6">
      ...
      <div className={clsx("rounded-2xl border border-border bg-soft", "divide-y divide-border")}>
        <div className="px-5">
          <SettingRow label={t(translation.Settings.DateFormat)} description={t(translation.Settings.DateFormatDesc)}>
            <SelectChip
