...
export type SettingsSection =
	"appearance" | "behavior" | "formatting" | "extensions" | "language" | "browser" | "about";
...
export const settingsNavItems: {
	...
	{
		id: "formatting",
		label: translation.Settings.Formatting,
		icon: "code",
		description: translation.Settings.FormattingDesc,
	},
	{
		id: "extensions",
		label: translation.Extensions.Title,
		icon: "package",
		description: translation.Extensions.NavDescription,
	},
	{
		id: "language",
...
export const languages: {
	...
	{
		code: "en",
		label: translation.Settings.English,
		native: "English",
		region: translation.Settings.UnitedStates,
	},
	{
		code: "kh",
		label: translation.Settings.Khmer,
		native: "ភាសាខ្មែរ",
		region: translation.Settings.Cambodia,
	},
	{
		code: "cn",
		label: translation.Settings.Chinese,
		native: "中文",
		region: translation.Settings.China,
	},
];
