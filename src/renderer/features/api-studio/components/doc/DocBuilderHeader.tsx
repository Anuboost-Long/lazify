  ...
  return (
    <header className="flex items-center gap-3 border-b border-border px-5 py-3">
      ...
      <span className="shrink-0 text-[11px] text-muted">
        {saving
          ? t(translation.ApiStudio.DocSaving)
          : sent
            ? t(translation.ApiStudio.DocAskAgentSent)
            : openQuestions > 0
              ? t(translation.ApiStudio.DocOpenQuestions, { count: openQuestions })
              : t(translation.ApiStudio.DocNoQuestions)}
      </span>
