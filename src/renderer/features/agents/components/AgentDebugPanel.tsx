    ...
    >
      ...
      <div className="min-h-0 flex-1 overflow-y-auto p-1.5">
        {terminal ? (
          <>
            <StatusRow
              label={t(translation.Agents.DebugScript)}
            ...
            <div className="px-1.5 py-1">
              ...
              <SmallText
                as="span"
                className={clsx("block", isRunning ? "!text-accent" : "!text-muted")}
              >
                {isRunning
                  ? t(translation.ScriptsPane.Running)
                  : t(translation.Agents.DebugExited)}
              </SmallText>
            </div>

            {pid ? (
              <StatusRow label={t(translation.Agents.DebugProcess)} value={String(pid)} />
            ) : null}
          ...
          <SmallText className="!text-muted px-1.5 py-2">
            {t(translation.Agents.DebugNoRun)}
          </SmallText>
        )}
      </div>
    </aside>
