          ...
          <div className="flex items-center gap-3 border-b border-border px-4 py-3">
            ...
            <div className="min-w-0 flex-1">
              <CardTitle className="truncate text-sm">
                {t(translation.LazyShield.Title)}
              </CardTitle>
          ...
          <div className="px-4 py-3">
            <div className="flex items-baseline gap-2">
              ...
              <SmallText className="!text-muted">
                {t(translation.LazyShield.BlockedLabel)}
              </SmallText>
            </div>
            ...
            <CaptionText tone="muted" className="mt-2 block leading-relaxed">
              {t(
                !ready && enabled
                  ? translation.LazyShield.Loading
                  : enabled
                    ? translation.LazyShield.Description
                    : translation.LazyShield.OffDescription
              )}
            </CaptionText>
          </div>
