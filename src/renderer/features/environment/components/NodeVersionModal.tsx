...
export function NodeVersionModal({ open, onClose, onSelect }: Readonly<NodeVersionModalProps>) {
					...
					<div className="flex items-center justify-between gap-4">
						<div>
							...
							<SectionTitle className="mt-1 text-2xl">
								{t(translation.NodeVersionModal.Title)}
							</SectionTitle>
						</div>
						<button
							type="button"
					...
					{state === "loading" && (
						<div className="flex items-center justify-center gap-3 py-8 text-sm text-muted">
							...
							<BodyText as="span" className="text-muted">
								{t(translation.NodeVersionModal.ScanningNvm)}
							</BodyText>
						</div>
					)}
						...
						<div className="space-y-3">
								...
								<div className="flex items-start gap-3">
									...
									<div>
										<BodyText className="font-semibold text-text">
											{t(translation.NodeVersionModal.NvmNotInstalled)}
										</BodyText>
							...
							>
								...
								<div className="flex items-center gap-3">
									...
									<div>
										<BodyText className="font-semibold text-accent">
											{t(translation.NodeVersionModal.InstallNvm)}
										</BodyText>
									...
									<UiIcon
										name="arrow-right"
										className="ml-auto h-4 w-4 text-accent/50 transition-transform duration-150 group-hover:translate-x-0.5"
									/>
								</div>
							</button>
						</div>
						...
						<div className="space-y-3">
							<div className="rounded-[20px] border border-border/60 bg-bg px-4 py-4">
								<div className="flex items-start gap-3">
									...
									<div>
										<BodyText className="font-semibold text-text">
											{t(translation.NodeVersionModal.NoVersionsFound)}
										</BodyText>
										<BodyText className="mt-1 text-xs text-muted">
					...
					{state === "installing" && (
						<div className="flex flex-col items-center gap-4 py-8">
							...
							<div className="text-center">
								<BodyText className="font-semibold text-text">
									{t(translation.NodeVersionModal.InstallingNvm)}
								</BodyText>
								<BodyText className="mt-1 text-xs text-muted">
									{t(translation.NodeVersionModal.InstallingNvmDesc)}
								</BodyText>
							</div>
						</div>
					)}
						...
						<div className="space-y-3">
							<div
								className={clsx(
									...
									installSuccess ? "border-success/20 bg-success/5" : "border-error/20 bg-error/5",
								)}
							>
								<div className="flex items-start gap-3">
									<div
									...
									<div>
										<BodyText
											className={clsx("font-semibold", installSuccess ? "text-success" : "text-error")}
										>
											{installSuccess
												? t(translation.NodeVersionModal.NvmSuccess)
												: t(translation.NodeVersionModal.NvmFailed)}
										</BodyText>
										<BodyText className="mt-1 text-xs text-muted">
											{installSuccess
							...
							{versions.map((ver, i) => (
								...
								>
									...
									<div className="flex items-center gap-3">
										...
										/>
										<MonoText as="span" className="text-sm font-semibold text-text">
											{ver.version}
										</MonoText>
										...
										<div className="flex flex-1 items-center gap-1.5">
											{ver.lts && (
												<PillText
													as="span"
													className="rounded-full border border-accent/20 bg-accent/10 px-2 py-0.5 text-[9px] text-accent"
												>
													LTS · {ver.lts}
												</PillText>
											)}
											{ver.current && (
												<PillText
													as="span"
													className="rounded-full border border-border bg-soft px-2 py-0.5 text-[9px] text-muted"
												>
													Active
												</PillText>
											)}
				...
				{state === "ready" && (
					<div className="border-t border-border px-6 py-4">
						<div className="mb-3 flex items-center gap-2">
							<OverlineText as="span" className="text-muted">
								{t(translation.GlobalTerm.Selected)}
							</OverlineText>
							<MonoText as="span" className="text-sm font-semibold text-accent">
								{selected}
							</MonoText>
						</div>
