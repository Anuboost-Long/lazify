 ...
 */
export function UninstallToolModal({ tool, open, onClose, onUninstalled }: UninstallToolModalProps) {
  ...
  return (
    <BaseModal open={open} onClose={state === "removing" ? undefined : onClose} cancellable={state !== "removing"}>
          ...
          {state === "confirm" && tool && (
            <div className="space-y-4">
              ...
              <div className="rounded-[16px] border border-border bg-bg px-4 py-3">
                ...
                <MonoText as="code" className="break-all text-sm text-error">{tool.uninstallCommand}</MonoText>
              </div>
          ...
          {state === "removing" && (
            <div className="flex flex-col items-center gap-4 py-6">
              ...
              <div className="text-center">
                <BodyText className="font-semibold text-text">{t(translation.UninstallToolModal.Removing, { name: tool?.displayName })}</BodyText>
