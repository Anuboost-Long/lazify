...
export function InstallToolModal({
	tool,
	open,
	onClose,
	onInstalled,
}: Readonly<InstallToolModalProps>) {
	...
	return (
		<BaseModal
			open={open}
			onClose={state === "installing" ? undefined : onClose}
			cancellable={state !== "installing"}
		>
						...
						<div className="flex flex-col items-center gap-4 py-6">
							...
							<div className="text-center">
								<BodyText className="font-semibold text-text">
									{t(translation.InstallToolModal.Installing, { name: tool?.displayName })}
								</BodyText>
								...
								<div className="flex items-start gap-3">
									...
									<div>
										<BodyText className={clsx("font-semibold", success ? "text-success" : "text-error")}>
											{success
												? t(translation.InstallToolModal.InstallSuccess, { name: tool?.displayName })
												: t(translation.InstallToolModal.InstallFailed)}
										</BodyText>
										<BodyText className="mt-1 text-xs text-muted">
											{success
