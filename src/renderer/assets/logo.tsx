...
export function Logo({
  ...
  return (
    ...
    >
      ...
      <line
        x1="6" y1="10.5" x2="9" y2="10.5"
        stroke={color}
        strokeWidth="1"
        strokeLinecap="round"
      />
      <rect
        x="9" y="9.5" width="3.5" height="2" rx="0.4"
        fill={color}
        fillOpacity="0.25"
        stroke={color}
        strokeWidth="0.6"
      ...
      <line
        x1="6" y1="13" x2="8.5" y2="13"
        stroke={color}
        strokeWidth="1"
        strokeLinecap="round"
      />
      <rect
        x="8.5" y="12" width="3" height="2" rx="0.4"
        fill={color}
        fillOpacity="0.25"
        stroke={color}
        strokeWidth="0.6"
      ...
      <line
        x1="6" y1="15.5" x2="8.5" y2="15.5"
        stroke={color}
        strokeWidth="1"
        strokeLinecap="round"
      />
      <rect
        x="8.5" y="14.5" width="2.5" height="2" rx="0.4"
        fill={color}
        fillOpacity="0.25"
        stroke={color}
        strokeWidth="0.6"
      ...
      <line
        x1="6" y1="17.5" x2="12.5" y2="17.5"
        stroke={color}
        strokeWidth="1"
        strokeLinecap="round"
      />
      <rect
        x="12.5" y="16.5" width="3.5" height="2" rx="0.4"
        fill={color}
        fillOpacity="0.25"
        stroke={color}
        strokeWidth="0.6"
      />
      <rect
        x="16.5" y="16.5" width="3" height="2" rx="0.4"
        fill={color}
        fillOpacity="0.18"
        stroke={color}
        strokeWidth="0.6"
