 ...
 * multi-window, journal-page, terminal, network, sparks, radar, health-cross),
 * so they are drawn by hand on the same 24x24 grid and keep the line icon's
 * silhouette — the active row swaps weight, not shape.
 *
 ...
 * The scope, filled.
 *
 * The dial encloses an area, so it fills. The four bearings sit outside it as
 * open lines — like the wrench handle, they stay strokes and only grow heavier,
 * which is what keeps a filled disc reading as a scope rather than a dot.
 */
export function RadarSolid(props: SVGProps<SVGSVGElement>) {
	return (
		<SolidSvg {...props}>
...
/**
 * The check-up mark, filled.
 *
 * The ring fills and the cross is punched back out of it with `evenodd`, so the
 * cross stays the shape of the hole rather than a stroke laid over the fill —
 * the same trick the house's threshold uses, and it survives any icon colour.
 */
export function HealthCrossSolid(props: SVGProps<SVGSVGElement>) {
	return (
		<SolidSvg {...props}>
			<path
				fillRule="evenodd"
				clipRule="evenodd"
				d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22ZM13.9 18H10.1C9.76863 18 9.5 17.7314 9.5 17.4V15.1C9.5 14.7686 9.23137 14.5 8.9 14.5H6.6C6.26863 14.5 6 14.2314 6 13.9V10.1C6 9.76863 6.26863 9.5 6.6 9.5H8.9C9.23137 9.5 9.5 9.23137 9.5 8.9V6.6C9.5 6.26863 9.76863 6 10.1 6H13.9C14.2314 6 14.5 6.26863 14.5 6.6V8.9C14.5 9.23137 14.7686 9.5 15.1 9.5H17.4C17.7314 9.5 18 9.76863 18 10.1V13.9C18 14.2314 17.7314 14.5 17.4 14.5H15.1C14.7686 14.5 14.5 14.7686 14.5 15.1V17.4C14.5 17.7314 14.2314 18 13.9 18Z"
			/>
		</SolidSvg>
	);
}
