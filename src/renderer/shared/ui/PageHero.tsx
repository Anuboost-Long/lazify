...
export function PageHero({
  ...
  return (
    ...
    >
      ...
      <CardShapes
        variant={2}
        className="text-accent/25 !opacity-100 dark:text-accent/30"
      />

      <div className="relative flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
        <div className="min-w-0 flex-1">
          {eyebrow ? <OverlineText>{t(eyebrow)}</OverlineText> : null}

          <SectionTitle
            className={clsx("!text-3xl lg:!text-4xl", eyebrow && "mt-3")}
          >
            {t(title)}
          </SectionTitle>
