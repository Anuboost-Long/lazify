 ...
 * left behind. Another running Lazify's are left where they are, and real repos
 * are never touched by this.
 */
export function cleanupShadowRepos(): void {
	pruneInstanceDirs(shadowStore(), Number);
