...
import { searchProject } from "../projects/project-search";
import type { ProjectSearchQuery } from "../projects/project-search";
import type { IpcContext } from "./context";

export function registerProjectHandlers(ctx: IpcContext) {
	ipcMain.handle(
		"lazify:search-project",
		async (_event, projectPath: string, query: ProjectSearchQuery) =>
			searchProject(projectPath, query),
	);
