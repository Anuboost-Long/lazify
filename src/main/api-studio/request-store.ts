...
/** A checked-in file answers the question by itself, however this machine voted. */
...
export function saveRequest(
  ...
  pruneBodies(
    directory,
    routeId,
    new Set([response?.bodyFile, ...examples.map((example) => example.bodyFile)].filter(Boolean) as string[])
  );
